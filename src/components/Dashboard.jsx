...
const Dashboard = () => {
  ...
  const cargarDatos = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/indicadores/cargar-datos`, {
        method: 'POST',
        headers: {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center p-8 bg-blue-50 border border-blue-200 rounded-lg max-w-md">
          ...
          <p className="text-blue-600 mb-6">No se encontraron indicadores. Carga los datos desde el archivo Excel.</p>
          ...
          <p className="text-xs text-gray-500 mt-4">
            Este proceso carga los datos desde "Base de datos.xlsx"
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Vista general del sistema de gestión de indicadores</p>
      </div>
            ...
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Total Indicadores</dt>
                    <dd className="text-lg font-medium text-gray-900">{datosVisualizacion.totalIndicadores}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">{Object.keys(datosVisualizacion.porArea).length}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Tipos de Indicador</dt>
                    <dd className="text-lg font-medium text-gray-900">{Object.keys(datosVisualizacion.porTipo).length}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Estados Únicos</dt>
                    <dd className="text-lg font-medium text-gray-900">{Object.keys(datosVisualizacion.porEstado).length}</dd>
                  </dl>
                </div>
              </div>
            </div>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-md">
        <div className="px-4 py-5 sm:px-6">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Indicadores Recientes</h3>
          <p className="mt-1 max-w-2xl text-sm text-gray-500">
            Lista de los últimos indicadores registrados en el sistema
          </p>
        </div>
        <ul className="divide-y divide-gray-200">
          {Array.isArray(indicadores) && indicadores.slice(0, 5).map((indicador) => (
            <li key={indicador.id}>
              <div className="px-4 py-4 sm:px-6">
                ...
                <div className="mt-2 sm:flex sm:justify-between">
                  ...
                  <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                    <p>
                      📅 {indicador.fechaInicioGeneral} - {indicador.fechaFinalizacionGeneral}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Distribución por Área</h3>
              <div className="space-y-3">
                {Object.entries(datosVisualizacion.porArea).map(([area, cantidad]) => (
                    ...
                    <div className="flex items-center">
                      <div className="w-20 bg-gray-200 rounded-full h-2 mr-2">
                        <div 
                          ...
                          style={{ width: `${(cantidad / datosVisualizacion.totalIndicadores) * 100}%` }}
                        ></div>
                      </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="space-y-3">
                {Object.entries(datosVisualizacion.porTipo).map(([tipo, cantidad]) => (
