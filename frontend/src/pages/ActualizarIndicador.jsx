...
const ActualizarIndicador = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    nombreHito: '' // Agregando el campo para el nombre del hito
  });
  ...
  const abrirModalActualizacion = (hito) => {
    ...
    setFormData({
      ...
      nombreHito: hito.nombreHito || '' // Inicializando el nombre del hito
    });
  ...
  const cerrarModal = () => {
    ...
    setFormData({ avanceHito: 0, estadoHito: '', comentarioHito: '', fechaFinalizacionHito: '', fechaInicioHito: '', nombreHito: '' });
  };
              ...
              <CardContent className="pt-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-6">
                    {/* Campo para editar el nombre del hito */}
                    <div className="space-y-2">
                      <Label htmlFor="nombreHito">Nombre del Hito</Label>
                      <Input
                        id="nombreHito"
                        name="nombreHito"
                        value={formData.nombreHito}
